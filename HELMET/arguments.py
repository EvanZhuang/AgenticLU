...
def parse_arguments():
    ...
    # prompting settings, only works for eval_prompting.py
    parser.add_argument("--prompting_method", type=str, choices=[None, "stepbystep", "fact&reflect", "plan&solve", "longrag"], default=None, help="prompting setting")
